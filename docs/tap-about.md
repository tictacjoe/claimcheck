...
**Individuals are named, not vague institutions.** Where it can be
documented, an entry says which specific official did what, rather than
attributing an action to "the administration" generically.
...
Four trackers, organized by kind of claim, not by target:
